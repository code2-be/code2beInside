...
abstract class BaseCommentPeer
{
    ...
    const OM_CLASS = 'Code2be\\Model\\Comment';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Code2be\\Model\\map\\CommentTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Message', 'TopicId', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'message', 'topicId', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID, CommentPeer::MESSAGE, CommentPeer::TOPIC_ID, CommentPeer::CREATED_AT, CommentPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'MESSAGE', 'TOPIC_ID', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'message', 'topic_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Message' => 1, 'TopicId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'message' => 1, 'topicId' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID => 0, CommentPeer::MESSAGE => 1, CommentPeer::TOPIC_ID => 2, CommentPeer::CREATED_AT => 3, CommentPeer::UPDATED_AT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'MESSAGE' => 1, 'TOPIC_ID' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'message' => 1, 'topic_id' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function doCountJoinTopic(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::TOPIC_ID, TopicPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Topic objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinTopic(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (Topic)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Topic)
                $obj2->addComment($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCommentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Code2be\Model\map\CommentTableMap());
      }
    }
