...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'FirstName', 'LastName', 'Email', 'Password', 'PhoneNumber', 'Role', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'firstName', 'lastName', 'email', 'password', 'phoneNumber', 'role', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::FIRST_NAME, UserPeer::LAST_NAME, UserPeer::EMAIL, UserPeer::PASSWORD, UserPeer::PHONE_NUMBER, UserPeer::ROLE, UserPeer::CREATED_AT, UserPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FIRST_NAME', 'LAST_NAME', 'EMAIL', 'PASSWORD', 'PHONE_NUMBER', 'ROLE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'first_name', 'last_name', 'email', 'password', 'phone_number', 'role', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'Email' => 3, 'Password' => 4, 'PhoneNumber' => 5, 'Role' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'firstName' => 1, 'lastName' => 2, 'email' => 3, 'password' => 4, 'phoneNumber' => 5, 'role' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::FIRST_NAME => 1, UserPeer::LAST_NAME => 2, UserPeer::EMAIL => 3, UserPeer::PASSWORD => 4, UserPeer::PHONE_NUMBER => 5, UserPeer::ROLE => 6, UserPeer::CREATED_AT => 7, UserPeer::UPDATED_AT => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FIRST_NAME' => 1, 'LAST_NAME' => 2, 'EMAIL' => 3, 'PASSWORD' => 4, 'PHONE_NUMBER' => 5, 'ROLE' => 6, 'CREATED_AT' => 7, 'UPDATED_AT' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'first_name' => 1, 'last_name' => 2, 'email' => 3, 'password' => 4, 'phone_number' => 5, 'role' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
