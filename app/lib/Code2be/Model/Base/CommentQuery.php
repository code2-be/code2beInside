...
namespace Code2be\Model\Base;

use \Exception;
use \PDO;
use Code2be\Model\Comment as ChildComment;
use Code2be\Model\CommentQuery as ChildCommentQuery;
use Code2be\Model\Map\CommentTableMap;
 ...
 * @method     ChildCommentQuery orderByMessage($order = Criteria::ASC) Order by the message column
 * @method     ChildCommentQuery orderByTopicId($order = Criteria::ASC) Order by the topic_id column
 ...
 * @method     ChildCommentQuery groupByMessage() Group by the message column
 * @method     ChildCommentQuery groupByTopicId() Group by the topic_id column
 ...
 *
 * @method     ChildCommentQuery leftJoinTopic($relationAlias = null) Adds a LEFT JOIN clause to the query using the Topic relation
 * @method     ChildCommentQuery rightJoinTopic($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Topic relation
 * @method     ChildCommentQuery innerJoinTopic($relationAlias = null) Adds a INNER JOIN clause to the query using the Topic relation
 *
 * @method     \Code2be\Model\TopicQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildComment findOneByMessage(string $message) Return the first ChildComment filtered by the message column
 * @method     ChildComment findOneByTopicId(int $topic_id) Return the first ChildComment filtered by the topic_id column
 ...
 * @method     ChildComment requireOneByMessage(string $message) Return the first ChildComment filtered by the message column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildComment requireOneByTopicId(int $topic_id) Return the first ChildComment filtered by the topic_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildComment[]|ObjectCollection findByMessage(string $message) Return ChildComment objects filtered by the message column
 * @method     ChildComment[]|ObjectCollection findByTopicId(int $topic_id) Return ChildComment objects filtered by the topic_id column
...
abstract class CommentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Code2be\Model\Base\CommentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'code2be', $modelName = '\\Code2be\\Model\\Comment', $modelAlias = null)
    {
    ...
    public function filterByMessage($message = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CommentTableMap::COL_MESSAGE, $message, $comparison);
    }
    ...
    public function filterByTopicId($topicId = null, $comparison = null)
    {
        if (is_array($topicId)) {
            ...
            if (isset($topicId['min'])) {
                $this->addUsingAlias(CommentTableMap::COL_TOPIC_ID, $topicId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($topicId['max'])) {
                $this->addUsingAlias(CommentTableMap::COL_TOPIC_ID, $topicId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CommentTableMap::COL_TOPIC_ID, $topicId, $comparison);
    }
    ...
    /**
     * Filter the query by a related \Code2be\Model\Topic object
     *
     * @param \Code2be\Model\Topic|ObjectCollection $topic The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($topic instanceof \Code2be\Model\Topic) {
            return $this
                ->addUsingAlias(CommentTableMap::COL_TOPIC_ID, $topic->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommentTableMap::COL_TOPIC_ID, $topic->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByTopic() only accepts arguments of type \Code2be\Model\Topic or Collection');
        }
    }
