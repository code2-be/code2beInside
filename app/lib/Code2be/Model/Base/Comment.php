...
use Code2be\Model\Topic as ChildTopic;
use Code2be\Model\TopicQuery as ChildTopicQuery;
 ...
 *
 *
* @package    propel.generator.Code2be.Model.Base
*/
abstract class Comment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Code2be\\Model\\Map\\CommentTableMap';
    ...
    /**
     * Initializes internal state of Code2be\Model\Base\Comment object.
     */
     ...
     * @return $this|\Code2be\Model\Comment The current object (for fluent API support)
     */
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[CommentTableMap::COL_MESSAGE] = true;
        }
    ...
    public function setTopicId($v)
    {
        ...
        if ($this->topic_id !== $v) {
            $this->topic_id = $v;
            $this->modifiedColumns[CommentTableMap::COL_TOPIC_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CommentTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            $this->message = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CommentTableMap::translateFieldName('TopicId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Code2be\\Model\\Comment'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'message';
        }
        if ($this->isColumnModified(CommentTableMap::COL_TOPIC_ID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Code2be\Model\Comment
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Code2be\Model\Comment The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_MESSAGE)) {
            $criteria->add(CommentTableMap::COL_MESSAGE, $this->message);
        }
        if ($this->isColumnModified(CommentTableMap::COL_TOPIC_ID)) {
            $criteria->add(CommentTableMap::COL_TOPIC_ID, $this->topic_id);
        }
        if ($this->isColumnModified(CommentTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Code2be\Model\Comment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Code2be\Model\Comment Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aTopic) {
            $this->aTopic->removeComment($this);
        }
        $this->id = null;
        $this->message = null;
        $this->topic_id = null;
