...
use Code2be\Model\Map\TopicTableMap;
 ...
 *
 * @method     ChildTopicQuery leftJoinComment($relationAlias = null) Adds a LEFT JOIN clause to the query using the Comment relation
 * @method     ChildTopicQuery rightJoinComment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Comment relation
 * @method     ChildTopicQuery innerJoinComment($relationAlias = null) Adds a INNER JOIN clause to the query using the Comment relation
 *
 * @method     \Code2be\Model\CommentQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class TopicQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Code2be\Model\Base\TopicQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'code2be', $modelName = '\\Code2be\\Model\\Topic', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, title, created_at, updated_at FROM topic WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query by a related \Code2be\Model\Comment object
     *
     * @param \Code2be\Model\Comment|ObjectCollection $comment the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($comment instanceof \Code2be\Model\Comment) {
            return $this
                ->addUsingAlias(TopicTableMap::COL_ID, $comment->getTopicId(), $comparison);
            ...
            throw new PropelException('filterByComment() only accepts arguments of type \Code2be\Model\Comment or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Code2be\Model\CommentQuery A secondary query class using the current class as primary query
     */
    public function useCommentQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinComment($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Comment', '\Code2be\Model\CommentQuery');
    }
