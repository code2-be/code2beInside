...
use \Exception;
use \PDO;
use Code2be\Model\User as ChildUser;
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Code2be\Model\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'code2be', $modelName = '\\Code2be\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, first_name, last_name, email, password, phone_number FROM user WHERE id = :p0';
        try {
